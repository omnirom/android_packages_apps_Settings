...
public class PowerUsageSummary extends PreferenceFragment implements
    ...
    private static final int SUBMENU_BATTERY_PERCENT_ONLY   = Menu.FIRST + 7;
    private static final int SUBMENU_BATTERY_PERCENT_LEFT_OF_BAR = Menu.FIRST + 7;
    private static final int SUBMENU_BATTERY_NONE           = Menu.FIRST + 8;
