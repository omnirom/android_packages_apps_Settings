...
class FooterPreferenceController(context: Context, prefKey: String) :
    ...
    init {
        introductionTitle = context.getString(R.string.reduce_bright_colors_about_title)
        summary = context.getText(R.string.reduce_bright_colors_preference_subtitle)
    }
}
