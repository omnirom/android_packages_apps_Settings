...
import org.omnirom.omnigears.preference.SlimSeekBarPreference;
...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (isDozeAvailable(activity)) {
            ...
            if (mDozeShakeThreshold != null) {
                ...
                mDozeShakeThreshold.isMilliseconds(true);
                mDozeShakeThreshold.setInterval(1);
                mDozeShakeThreshold.minimumValue(1);
    ...
    private void updateDozeOptions() {
        ...
        if (mDozeShakeThreshold != null) {
            ...
            mDozeShakeThreshold.setInitValue(statusDozeShakeThreshold - 1);
        }
    }
