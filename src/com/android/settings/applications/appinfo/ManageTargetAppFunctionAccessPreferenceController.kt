...
/** A PreferenceController handling the logic for Agent access of an app settings. */
class ManageTargetAppFunctionAccessPreferenceController(context: Context, key: String) :
        ...
        availabilityStatus =
            if (
                AppFunctionAccessUtil.isAppFunctionAccessEnabled(mContext) &&
                    appFunctionManagerWrapper.isValidTarget(mAppEntry.info.packageName)
            ) {
                AVAILABLE
            } else {
