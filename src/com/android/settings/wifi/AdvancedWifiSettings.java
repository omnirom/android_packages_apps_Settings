...
public class AdvancedWifiSettings extends SettingsPreferenceFragment
    ...
    private void initPreferences() {
        ...
        if (ccodePref != null) {
            ...
            if (value != null) {
                ...
                updateChannelSummary(ccodePref, value);
            } else {
    ...
    private void updateChannelSummary(Preference channelPref, int index) {
        String[] summaries = getResources().getStringArray(R.array.wifi_countrycode_entries);
        String channel = getResources().getString(R.string.wifi_setting_countrycode_summary);
        channelPref.setSummary(channel + "(" + summaries[index] + ")");
    }
