...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (action.equals(SmsCallController.START_NOTIFICATION_COMMAND)){
            SmsCallController.getInstance(context).startNotification();
        } else if (action.equals(SmsCallController.STOP_NOTIFICATION_COMMAND)){
            SmsCallController.getInstance(context).stopNotification();
