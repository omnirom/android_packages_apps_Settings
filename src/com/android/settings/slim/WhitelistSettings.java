...
public class WhitelistSettings extends ListFragment {
    ...
    private class EntryEditDialog extends DialogFragment
        ...
        private QuietHoursHelper.WhitelistContact mContact;

        private static final int REQUEST_CODE_PICKER = 1;
        private static final int COLUMN_NUMBER = 0;

        public EntryEditDialog(QuietHoursHelper.WhitelistContact contact) {
            super();
            mContact = contact;
        }
        ...
        private void updateEntry() {
           ...
           if (mContact == null){
                QuietHoursHelper.WhitelistContact contact = new QuietHoursHelper.WhitelistContact(number, bypassCall, bypassMessage);
