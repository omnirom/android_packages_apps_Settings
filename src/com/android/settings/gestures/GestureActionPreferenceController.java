...
public class GestureActionPreferenceController extends BasePreferenceController implements
    ...
    public GestureActionPreferenceController(Context context, String key) {
        super(context, key);
    }
