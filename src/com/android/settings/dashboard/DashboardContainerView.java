...
public class DashboardContainerView extends ViewGroup {
    ...
    public static final String PREF_DASHBOARD_COLUMNS_RESIZE = "dashboard_colums_resize";
    ...
    public DashboardContainerView(Context context, AttributeSet attrs) {
        ...
        mColumnsResize = prefs.getInt(PREF_DASHBOARD_COLUMNS_RESIZE,1) == 1;
