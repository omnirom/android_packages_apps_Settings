...
@Composable
fun ManageAgentAppFunctionAccessPreference(app: ApplicationInfo) {
                ...
                flow {
                        emit(
                            AppFunctionAccessUtil.isAppFunctionAccessEnabled(context) &&
                                AppFunctionManagerWrapperImpl(context).isValidAgent(app.packageName)
                        )
                    }
    ...
    val summary = stringResource(R.string.manage_agent_app_function_access_settings_summary)
    Preference(
        object : PreferenceModel {
            override val title =
                stringResource(R.string.manage_agent_app_function_access_settings_title)
