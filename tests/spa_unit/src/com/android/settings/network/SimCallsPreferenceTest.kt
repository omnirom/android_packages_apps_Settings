...
class SimCallsPreferenceTest {
    ...
    private val preference = SimCallsPreference()
    ...
    fun getSummary_returnSubDisplayName() {
        whenever(SubscriptionManager.getDefaultVoiceSubscriptionId()).thenReturn(TEST_SUB_ID)
