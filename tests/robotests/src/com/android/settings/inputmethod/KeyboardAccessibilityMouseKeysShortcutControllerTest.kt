...
/**
 * Test for [KeyboardAccessibilityMouseKeysShortcutController]
 */
@RunWith(RobolectricTestRunner::class)
class KeyboardAccessibilityMouseKeysShortcutControllerTest {
    @get:Rule
    val setFlagsRule = SetFlagsRule()
    private val context = ApplicationProvider.getApplicationContext<Context>()
    private val controller = KeyboardAccessibilityMouseKeysShortcutController(context, "prefKey")
