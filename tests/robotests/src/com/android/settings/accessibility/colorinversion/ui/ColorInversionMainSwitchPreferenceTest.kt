...
class ColorInversionMainSwitchPreferenceTest {
    @get:Rule val settingStoreRule = SettingsStoreRule()

    private val appContext: Context = ApplicationProvider.getApplicationContext()
    private val preference = ColorInversionMainSwitchPreference(appContext)

    @Test
    fun bindWidget_featureOn_toggleIsChecked() {
        setColorInversionStateInSetting(enable = true)
    ...
    fun bindWidget_featureOff_toggleIsNotChecked() {
        setColorInversionStateInSetting(enable = false)
        val widget = preference.createAndBindWidget<MainSwitchPreference>(appContext)
    ...
    fun turnOnFeature_settingSetToTrue() {
        ...
        assertThat(getColorInversionStateInSetting()).isTrue()
    }
    ...
    fun turnOffFeature_settingSetToFalse() {
        ...
        assertThat(getColorInversionStateInSetting()).isFalse()
    }
    ...
    fun getKey_matchesSettingKey() {
        assertThat(preference.key)
            .isEqualTo(Settings.Secure.ACCESSIBILITY_DISPLAY_INVERSION_ENABLED)
    }

    @Test
    fun getTitle_returnCorrectTitle() {
        assertThat(preference.title)
            .isEqualTo(R.string.accessibility_display_inversion_switch_title)
    }

    private fun setColorInversionStateInSetting(enable: Boolean) {
    ...
    private fun getColorInversionStateInSetting(): Boolean =
