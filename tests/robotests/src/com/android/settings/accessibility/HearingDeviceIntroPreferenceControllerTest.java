...
/**
 * Tests for {@link HearingDeviceIntroPreferenceController}.
 */
@RunWith(RobolectricTestRunner.class)
public class HearingDeviceIntroPreferenceControllerTest {
    ...
    private HearingDeviceIntroPreferenceController mController;
    private TopIntroPreference mPreference;

    @Before
    public void setUp() {
        mController = new HearingDeviceIntroPreferenceController(mContext, "test_key", mHelper);
    ...
    public void displayPreference_ashaHapSupported_expectedTitle() {
        ...
        assertThat(mPreference.getTitle().toString()).isEqualTo(
                mContext.getString(R.string.accessibility_hearingaid_intro));
    }
