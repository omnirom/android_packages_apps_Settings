...
class DockingSoundPreferenceTest {
    ...
    private val dockingSoundPreference = DockingSoundPreference()

    @Test
    fun isAvailable_configTrue_shouldReturnTrue() {
        mockResources.stub { on { getBoolean(anyInt()) } doReturn true }

        assertThat(dockingSoundPreference.isAvailable(context)).isTrue()
    }
    ...
    fun isAvailable_configFalse_shouldReturnFalse() {
        ...
        assertThat(dockingSoundPreference.isAvailable(context)).isFalse()
    }
    ...
    private fun getSwitchPreference(): SwitchPreferenceCompat =
        dockingSoundPreference.createAndBindWidget(context)

    private fun enableScreenLockSound(enabled: Boolean?) =
        SettingsGlobalStore.get(context).setBoolean(DOCK_SOUNDS_ENABLED, enabled)
}
// LINT.ThenChange(DockingSoundPreferenceControllerTest.java)
